export default function Footer() {
  return (
    <footer className="text-gray-700 body-font" style={{ width: "100%" }}>
      ...
      <div className="border-t border-gray-200">
        <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
          <div className="flex md:flex-no-wrap flex-wrap justify-center md:justify-start">
            ...
            <p className="text-gray-500 text-sm md:ml-6 md:mt-0 mt-4 sm:text-left text-center">
              <br />
              <a className="text-gray-500 ml-20">Privacy Policy</a>
              <a className="text-gray-500 ml-20">FAQ</a>
              <a className="text-gray-500 ml-20">Terms of service</a>
            </p>
          </div>
